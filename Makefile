...
clean :
	$(call RM,$(OBJDIR))
flash :
	st-flash --reset write $(OBJDIR)/FH_STM32.bin 0x8000000 
...
C_FLAGS += -DMBED_BUILD_TIMESTAMP=1540770283.16
...
CXX_FLAGS += -DMBED_BUILD_TIMESTAMP=1540770283.16
...
ASM_FLAGS += -I../TinyGPS
ASM_FLAGS += -I../mbed
ASM_FLAGS += -I../mbed-STM32F103C8T6
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F103RB
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F103RB/TARGET_STM
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F103RB/TARGET_STM/TARGET_STM32F1
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F103RB/TARGET_STM/TARGET_STM32F1/TARGET_NUCLEO_F103RB
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F103RB/TARGET_STM/TARGET_STM32F1/TARGET_NUCLEO_F103RB/device
ASM_FLAGS += -I../mbed/TARGET_NUCLEO_F103RB/TARGET_STM/TARGET_STM32F1/device
ASM_FLAGS += -I../mbed/drivers
ASM_FLAGS += -I../mbed/hal
ASM_FLAGS += -I../mbed/platform
ASM_FLAGS += -include
ASM_FLAGS += /filer/workspace_data/exports/2/25f6a67b94e867c081cfef41078c12ac/FH_STM32/mbed_config.h
ASM_FLAGS += -x
ASM_FLAGS += assembler-with-cpp
ASM_FLAGS += -c
ASM_FLAGS += -Wall
